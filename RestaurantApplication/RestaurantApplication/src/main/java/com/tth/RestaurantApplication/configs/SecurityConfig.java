        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
                httpSecurity
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers("/api/menu_items/admin/**").hasRole("ADMIN")
                                                ...
                                                .requestMatchers("/api/order_item/**").hasAnyRole("STAFF", "CUSTOMER")
                                                .requestMatchers("/api/stripe").hasRole("CUSTOMER")
