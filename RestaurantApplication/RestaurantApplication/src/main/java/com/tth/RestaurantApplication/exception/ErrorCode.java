...
public enum ErrorCode {
    ...
    RESERVATION_TOO_SOON(5002,
            "Cannot book new reservation. Previous reservation check-in time is less than 6 hours from now"),
    ...
    INVALID_VOUCHER_CONFIG(10010, "Cấu hình voucher không hợp lệ: Kiểm tra mâu thuẫn giữa loại quà tặng và hạng mục");
