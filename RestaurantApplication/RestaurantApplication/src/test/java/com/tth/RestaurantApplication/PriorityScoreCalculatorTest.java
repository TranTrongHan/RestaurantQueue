...
// }
// @Test
// @DisplayName("Nên tính điểm ưu tiên cao cho món của khách VIP, đã chờ lâu và
// phức tạp")
...
// orderSessionService.calculatePriorityScore(vipOrderItem);

// // Assert
// double expectedScore = BigDecimal.valueOf(27.5).setScale(2,
// RoundingMode.HALF_UP).doubleValue();
// assertThat(calculatedScore).isEqualTo(expectedScore);
// }
// @Test
// @DisplayName("Nên tính điểm ưu tiên thấp (cao) cho món của khách thường, vừa
// order và đơn giản")
...
// // Act
// double calculatedScore =
// orderSessionService.calculatePriorityScore(regularOrderItem);

// // Assert
// double expectedScore = BigDecimal.valueOf(97.5).setScale(2,
// RoundingMode.HALF_UP).doubleValue();
// assertThat(calculatedScore).isEqualTo(expectedScore);
// }
...
// double expectedScore = BigDecimal.valueOf(90.0).setScale(2,
// RoundingMode.HALF_UP).doubleValue();
// assertThat(calculatedScore).isEqualTo(expectedScore);
// }
...
// // Assert
// // Tính điểm mong đợi: 100 (Base) - 0 (VIP) - 30 (Chờ) - (10 * 0.5) (Nấu) =
// 65
// double expectedScore = BigDecimal.valueOf(65.0).setScale(2,
// RoundingMode.HALF_UP).doubleValue();
// assertThat(calculatedScore).isEqualTo(expectedScore);
// }
// @Test
...
// // Assert
// // Tính điểm mong đợi: 100 (Base) - 0 (VIP) - 60 (Chờ) - (10 * 0.5) (Nấu) =
// 35
// double expectedScore = BigDecimal.valueOf(35.0).setScale(2,
// RoundingMode.HALF_UP).doubleValue();
// assertThat(calculatedScore).isEqualTo(expectedScore);
// }
// @Test
...
// double expectedScore = BigDecimal.valueOf(99.0).setScale(2,
// RoundingMode.HALF_UP).doubleValue();
// assertThat(calculatedScore).isEqualTo(expectedScore);
// }
...
// // Assert
// // Tính điểm mong đợi: 100 (Base) - 0 (VIP) - 0 (Chờ) - (15 * 0.5) (Nấu) =
// 92.5
// double expectedScore = BigDecimal.valueOf(92.5).setScale(2,
// RoundingMode.HALF_UP).doubleValue();
// assertThat(calculatedScore).isEqualTo(expectedScore);
// }
